package com.example.realtimeimageprocessing;
...
import com.example.realtimeimageprocessing.camera.CameraFragment;
import com.example.realtimeimageprocessing.tflite.Classifier;
import com.example.realtimeimageprocessing.utils.YuvToRgbConverter;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void onRequestPermissionsResult(
        ...
        if(requestCode == PERMISSION_REQUEST_CODE){
            if(grantResults.length > 0 && allPermissionGranted(grantResults)){
                setFragment();
            }else{
    ...
    private boolean allPermissionGranted(final int[] grantResults) {
